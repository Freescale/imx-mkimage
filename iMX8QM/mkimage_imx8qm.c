...
/* Boot Data */
/* Note that this structure changed for iMX8QM (compared to iMX8DV): */
/* The structure size is now 0x90 (was 0x80). */
typedef struct {
...
}  __attribute__((packed)) boot_data_v3_t;		/*144*/
...
typedef struct {
	...
	boot_data_v3_t boot_data; /*144*/
	dcd_v2_t dcd_table; /*2880*/
}  __attribute__((packed)) imx_header_v3_t; /*3088*/
